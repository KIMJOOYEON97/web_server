 ...
 *
 * Servlet 생명주기
 * - was구동내내 딱 하나의 객체만 만들어져서 처린된다. (singletone방식)
 * 1. Servlet 객체생성(기본 생성자 호출) 		- 최초 client호출시 1회
 * 2. init메소드 호출 						- 최초 client호출시 1회
 * 3. HttpServlet의 service메소드 호출 		- client매 요청마다
 * 4. 전송방식에 따라 doGet | doPost 호출 		- client매 요청마다
...
public class TestPerson1Servlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) 
    	...
    	//매 요청시 사용되는 sevlet객체는 동일하다.
    	System.out.println(this.hashCode());
        
    	request.setCharacterEncoding("utf-8");
    	
        //1. 사용자입력값 가져오기 //request에 요청관련 사항이 들어있다.
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) 
    	...
    	request.setCharacterEncoding("utf-8"); //http가 utf-8로 써진 것이라고 명시해줌
